...
export class GodownPurchaseDetailsService {
    ...
    // Find the godownpurchase based on the ID
    ...
    // List the godownpurchase details
    ...
    // Delete the godownpurchase using Id
