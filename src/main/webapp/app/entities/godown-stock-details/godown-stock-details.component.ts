...
export class GodownStockDetailsComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.godownStockDetailsService
            .query({
                page: this.page - 1,
            ...
            .subscribe(
                (res: HttpResponse<IGodownStockDetails[]>) => this.paginateGodownStockDetails(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/godown-stock-details'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    private paginateGodownStockDetails(data: IGodownStockDetails[], headers: HttpHeaders) {
