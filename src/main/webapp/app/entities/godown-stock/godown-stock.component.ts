...
export class GodownStockComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll() {
        this.godownStockService
            ...
            .subscribe(
                (res: HttpResponse<IGodownStock[]>) => this.paginateGodownStocks(res.body, res.headers),
    ...
    ngOnInit() {
        ...
        this.registerChangeInGodownStocks();
    }
    ...
    registerChangeInGodownStocks() {
        this.eventSubscriber = this.eventManager.subscribe('godownStockListModification', response => this.loadAll());
    }
