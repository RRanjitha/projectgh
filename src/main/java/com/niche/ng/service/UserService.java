 ...
 *  Target: yarn
 *  -----------------------------------------------------------------------------
 *  File Description    : This file performs UserService
 *
 *******************************************************************************/
...
import com.niche.ng.repository.AuthorityRepository;
import com.niche.ng.config.Constants;
import com.niche.ng.repository.UserRepository;
import com.niche.ng.security.SecurityUtils;
import com.niche.ng.service.dto.UserDTO;
...
public class UserService {
    ...
    public UserDTO getUserFromAuthentication(OAuth2Authentication authentication) {
        log.debug("user service authentication : " + authentication);
