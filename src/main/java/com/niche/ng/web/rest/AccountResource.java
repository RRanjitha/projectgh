 ...
 *  Target: yarn
 *  -----------------------------------------------------------------------------
 *  File Description    : This file performs AccountResource.
 *
 *******************************************************************************/
package com.niche.ng.web.rest;

import com.niche.ng.service.UserService;
import com.niche.ng.service.dto.UserDTO;
import com.niche.ng.web.rest.errors.InternalServerErrorException;
...
public class AccountResource {
    ...
    public UserDTO getAccount(Principal principal) {
        log.debug("Get Account details : " + principal);
        if (principal != null) {
