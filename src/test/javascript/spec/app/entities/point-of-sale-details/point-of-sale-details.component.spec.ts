...
import { PointOfSaleDetailsComponent } from 'app/entities/point-of-sale-details/point-of-sale-details.component';
...
describe('Component Tests', () => {
    describe('PointOfSaleDetails Management Component', () => {
        let comp: PointOfSaleDetailsComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PointOfSaleDetailsComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new PointOfSaleDetails(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.pointOfSaleDetails[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
