...
import { GodownStockComponent } from 'app/entities/godown-stock/godown-stock.component';
...
describe('Component Tests', () => {
    describe('GodownStock Management Component', () => {
        let comp: GodownStockComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(GodownStockComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.godownStocks[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
