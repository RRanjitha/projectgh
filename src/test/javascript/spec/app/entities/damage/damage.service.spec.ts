...
describe('Service Tests', () => {
    describe('Damage Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(DamageService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/damages';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Damage', () => {
                service.create(new Damage(null)).subscribe(received => {
            ...
            it('should update a Damage', () => {
                service.update(new Damage(123)).subscribe(received => {
