...
import { GodownComponent } from 'app/entities/godown/godown.component';
import { GodownService } from 'app/entities/godown/godown.service';
import { Godown } from 'app/shared/model/godown.model';

describe('Component Tests', () => {
    describe('Godown Management Component', () => {
        let comp: GodownComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(GodownComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.godowns[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
