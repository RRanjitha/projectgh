    ...
    describe('Nursery Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/nurseries';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Nursery', () => {
                service.create(new Nursery(null)).subscribe(received => {
            ...
            it('should update a Nursery', () => {
                service.update(new Nursery(123)).subscribe(received => {
