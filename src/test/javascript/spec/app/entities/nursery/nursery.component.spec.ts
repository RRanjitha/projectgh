...
import { NurseryComponent } from 'app/entities/nursery/nursery.component';
import { NurseryService } from 'app/entities/nursery/nursery.service';
import { Nursery } from 'app/shared/model/nursery.model';

describe('Component Tests', () => {
    describe('Nursery Management Component', () => {
        let comp: NurseryComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(NurseryComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.nurseries[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
