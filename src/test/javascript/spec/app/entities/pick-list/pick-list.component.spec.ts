...
import { PickListComponent } from 'app/entities/pick-list/pick-list.component';
...
describe('Component Tests', () => {
    describe('PickList Management Component', () => {
        let comp: PickListComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PickListComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.pickLists[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
