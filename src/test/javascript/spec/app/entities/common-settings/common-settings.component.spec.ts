...
import { CommonSettingsComponent } from 'app/entities/common-settings/common-settings.component';
...
describe('Component Tests', () => {
    describe('CommonSettings Management Component', () => {
        let comp: CommonSettingsComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CommonSettingsComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.commonSettings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
